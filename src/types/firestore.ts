...
export const congregationSchema = managedDocumentSchema.extend({
  ...
  publicTalkCoordinatorName: z.string().optional().default(''),
  publicTalkCoordinatorPhone: z.string().optional().default(''),
  publicTalkCoordinatorEmail: z.string().optional().default(''),
